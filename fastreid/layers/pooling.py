...
class GlobalAvgPool(nn.AdaptiveAvgPool2d):
    def __init__(self, output_size=1, *_args, **_kwargs):
...
class GeneralizedMeanPooling(nn.Module):
    ...
    def __init__(self, norm=3, output_size=(1, 1), eps=1e-6, *_args, **_kwargs):
...
class FastGlobalAvgPool(nn.Module):
    def __init__(self, flatten=False, *_args, **_kwargs):
        super().__init__()
