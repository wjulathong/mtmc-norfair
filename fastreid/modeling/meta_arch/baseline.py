...
from ..losses.circle_loss import pairwise_circleloss, pairwise_cosface
from ..losses.cross_entropy_loss import cross_entropy_loss, log_accuracy
...
class Baseline(nn.Module):
    ...
    def forward(self, batched_inputs):
        ...
        if self.training:
            assert "targets" in batched_inputs, (
    ...
    def losses(self, outputs, gt_labels):
        ...
        if "CrossEntropyLoss" in loss_names:
            ...
            loss_dict["loss_cls"] = cross_entropy_loss(
                cls_outputs, gt_labels, ce_kwargs.get("eps"), ce_kwargs.get("alpha")
            ) * ce_kwargs.get("scale")
